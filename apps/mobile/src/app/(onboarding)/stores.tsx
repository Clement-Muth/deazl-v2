  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: "#FAF9F6" }}>
      <View style={{ flex: 1, paddingHorizontal: 24, paddingTop: 48, paddingBottom: 40 }}>
        ...
        <Text style={{ fontSize: 14, color: "#78716C", marginBottom: 24, lineHeight: 20 }}>
        ...
        <TextInput
          ...
          style={{ borderRadius: 16, backgroundColor: "#fff", paddingHorizontal: 16, paddingVertical: 14, fontSize: 14, color: "#1C1917", borderWidth: 1, borderColor: "#E7E5E4", marginBottom: 12 }}
        />
            ...
            {results.slice(0, 5).map((s, i) => (
              <View key={s.id}>
                ...
                >
                  ...
                  <View style={{ width: 28, height: 28, borderRadius: 99, backgroundColor: "#FFF7ED", alignItems: "center", justifyContent: "center" }}>
                ...
                {i < Math.min(results.length, 5) - 1 && <View style={{ height: 1, backgroundColor: "#F5F3EF", marginHorizontal: 14 }} />}
              </View>
            ))}
          </View>
        )}
        ...
        <ScrollView style={{ flex: 1 }} showsVerticalScrollIndicator={false} contentContainerStyle={{ gap: 8, paddingBottom: 16 }}>
          ...
          {selected.map((s) => (
            <View key={s.id} style={{ flexDirection: "row", alignItems: "center", gap: 10, borderRadius: 14, backgroundColor: "#fff", paddingHorizontal: 14, paddingVertical: 12, borderWidth: 1, borderColor: "#E7E5E4" }}>
              <View style={{ width: 32, height: 32, borderRadius: 10, backgroundColor: "#FFF7ED", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
