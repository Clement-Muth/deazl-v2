...
Une bibliographie persistante est maintenue dans `biblio-rodin.md` (à la racine du projet). Elle contient les livres lus par l'utilisateur et les recommandations de lecture issues des sessions Rodin.
